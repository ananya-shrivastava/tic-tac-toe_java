 ...
 public class TicTacToeServer extends JFrame
 {
   ...
   private Condition otherPlayerTurn; // to wait for other player's turn
    ...
    players = new Player[ 2 ]; 
       ...
       outputArea.setFont(new Font(" Comic Sans MS ",Font.ITALIC,18));
       outputArea.setText( "Hey!! I'm the Server \n" +" Clients, Pls connect to me!");
       setSize( 300, 300 ); 
       setVisible( true ); 
   }  
    ...
    public boolean validateAndMove( int location, int player ) throws IOException
    {
           ...
           if(!isGameOver())
            ...
            { 
               // String name = "Congratulations";
                 ...
                 players[(currentPlayer+1)%2].output.format("CONGRATULATIONS!! you have  won\n");
                 //repaint();
                 players[currentPlayer].output.format("SORRY!! you lost \n");
               ...
               output.format( "Valid move in %d\n",location);
                  ...
                  else 
                  {
                    ...
                    output.flush ();            
                       ...
                       if(isGameOver())
               { 
                 players[(currentPlayer+1)%2]. output.format("Game over");
                  players[currentPlayer]. output.format("Game over");
                  output.flush();
                         } 
            }
